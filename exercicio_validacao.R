...
north_american_countries <-c("United States", "Canada", "Mexico") # vetor que identifica países latino americanos

north_america <- general_data %>% filter(location %in% north_american_countries) # filtra casos apenas no vetor
